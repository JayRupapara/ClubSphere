    ...
    <div className="bg-gray-100 font-sans leading-normal tracking-normal">
      <div className="right flex-1 p-2 m-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Registered Clubs */}
          <div className="lg:col-span-9 bg-white rounded-lg shadow p-6">
              ...
              <tbody>
                {clubs.map((club) => (
                  <tr key={club.id} className="border-t">
                    ...
                    <td className="py-2">
                      <button className="bg-gray-200 text-gray-800 px-3 py-1 rounded">Edit</button>
                    </td>
                    <td className="py-2">
                      <span className={`px-2 py-1 rounded ${getStatusColor(club.status)}`}>
                        {club.status}
                      </span>
                    </td>
                  </tr>

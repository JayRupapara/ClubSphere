        ...
        <>
            <div className='grid grid-cols-5'>
                ...
                <div className={`${sidebarOpen ? 'sm:col-span-4 col-span-2 ' : ' sm:col-span-5 col-span-5'}  h-screen overflow-y-auto px-3 overflow-x-hidden`}>
                    ...
                    <div className='z-10 mt-2 rounded-full bg-slate-200 text-secondary  flex justify-between items-center sticky top-2 w-full p-5 backdrop-blur-xl bg-opacity-50'>
